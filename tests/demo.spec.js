...
test.describe("Permission Demo", () => {
  ...
  test("add folder creates folder under selected folder", async ({ page }) => {
  ...
  test("cannot share a resource that was shared with you", async ({ page }) => {
