(def work-experience
  [{:job-title "Software developer"
    :company-name "Afi"
    :company-description "Afi is a leading Spanish provider of advisory, consultancy and training services in economics and finance."
    :period {:start (time/date-time 2008 10 1)
